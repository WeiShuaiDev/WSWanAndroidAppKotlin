package com.linwei.cams.module.mine.ui.myscore.mvvm.viewmodel
...
@HiltViewModel
class MyScoreViewModel @Inject constructor(private val myScoreModel: MyScoreModel) :
    MvvmViewModel() {
    ...
    fun requestListIntegralData(page: Int) {
        myScoreModel.fetchListIntegralData(page, object : ResponseCallback<Page<RankBean>> {
