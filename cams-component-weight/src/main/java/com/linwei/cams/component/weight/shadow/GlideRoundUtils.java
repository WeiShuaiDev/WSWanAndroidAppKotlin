package com.linwei.cams.component.weight.shadow;
    ...
    public static void setRoundCorner(final View view, final Drawable resourceId, final float cornerDipValue) {
        ...
        if (cornerDipValue == 0) {
            if (view.getMeasuredWidth() == 0 && view.getMeasuredHeight() == 0) {
                view.addOnLayoutChangeListener((v, left, top, right, bottom, oldLeft, oldTop, oldRight, oldBottom) -> Glide.with(view)
                        .asDrawable()
                        .load(resourceId)
